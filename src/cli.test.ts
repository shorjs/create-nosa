...
describe('template structure', () => {
  ...
  it('keeps TanStack Form templates aligned with their base templates except tanstack-form files', async () => {
    const templatesPath = join(import.meta.dir, 'templates')
    const files = new Glob('**/*')
    const variants = [
      {
        base: 'start-simple-shadcn',
        tanstack: 'start-simple-shadcn-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      },
      {
        ...
        tanstack: 'start-simple-shadcn-drizzle-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      {
        base: 'start-simple-shadcn-drizzle-betterauth',
        tanstack: 'start-simple-shadcn-drizzle-betterauth-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      },
      {
        ...
        tanstack: 'start-simple-shadcn-drizzle-betterauth-google-oauth-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      },
      {
        ...
        tanstack: 'start-vertical-shadcn-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      },
      {
        ...
        tanstack: 'start-vertical-shadcn-drizzle-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      {
        base: 'start-vertical-shadcn-drizzle-betterauth',
        tanstack: 'start-vertical-shadcn-drizzle-betterauth-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
      ...
      },
      {
        ...
        tanstack: 'start-vertical-shadcn-drizzle-betterauth-google-oauth-tanstack-form',
        changedFiles: [
          'AGENTS.md',
          'README.md',
          'bun.lock',
    ...
    for (const variant of variants) {
      const baseTemplatePath = join(templatesPath, variant.base)
      const tanstackTemplatePath = join(templatesPath, variant.tanstack)
      const baseFiles = new Set(
        await Array.fromAsync(
          files.scan({
            cwd: baseTemplatePath,
      ...
      const tanstackFiles = new Set(
        await Array.fromAsync(
          files.scan({
            cwd: tanstackTemplatePath,
            dot: true,
            onlyFiles: true,
          }),
        ),
      ...
      expect([...tanstackFiles].filter((filePath) => !baseFiles.has(filePath)).sort()).toEqual(
        variant.extraFiles,
      )
      ...
      for (const filePath of baseFiles) {
        ...
        expect(await Bun.file(join(tanstackTemplatePath, filePath)).text()).toBe(
          await Bun.file(join(baseTemplatePath, filePath)).text(),
        )
      }
    }
